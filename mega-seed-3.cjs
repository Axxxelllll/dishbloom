...
const RECIPES = [
  "Virgin Mojito, Virgin Espresso Martini, Shirley Temple",
  "Virgin Margarita, Virgin Pina Colada, Mocktail Aperol Spritz",
  "Arnold Palmer, Virgin Mary, Sleepy Girl Mocktail",
  "Spicy Guava Mocktail, Mango Habanero Fizz, Hot Honey Lemonade",
  "Cucumber Mint Fizz, Lavender Lemonade, Watermelon Basil Cooler",
  "Matcha Kiwi Fizz, Blue Spirulina Mermaid Refresher, Turmeric Ginger Wellness Shot",
  "Dirty Cherry Sprite, Dirty Dr Pepper, Raspberry Vanilla Dirty Soda",
  "Brazilian Mint Lemonade, Hibiscus Agua Fresca, Non-Alcoholic Horchata",
  "Pistachio Cream Cold Foam Latte, Hojicha Soft Serve, Blueberry Matcha Latte",
  "Dubai Chocolate Lava Cake, Pistachio Kunafa Croissant, Dubai Chocolate Cheesecake Bars",
  "Smash Burger Tacos, Birria Bao Buns, Bulgogi Cheesesteak Sandwich",
  "Tikka Masala Burrito, Kimchi Grilled Cheese, Shawarma Nachos",
  "Cottage Cheese Cookie Dough, Rice Paper Dumplings, Sheet Pan Quesadillas",
  "Crispy Gochujang Tofu, Sticky Sesame Tofu, General Tso Tofu",
  "Sweet Potato Peanut Curry, Chickpea Curry Chana Masala, Vegan Umami Ramen",
  "Vegan Lasagna, Cashew Alfredo Pasta, Vegan Bolognese",
  "Crispy Tofu Broccoli Stir Fry, Falafel Burgers, BBQ Jackfruit Pulled Pork Sandwiches",
  "Silken Tofu Chocolate Mousse, Vegan Banana Bread, Fudgy Vegan Brownies",
  "Shibuya Honey Toast, Turkish Egg Toast, Ricotta Hot Honey Peach Toast",
  "Soup Dumpling Lasagna, Mac and Cheese Waffles, Philly Cheesesteak Egg Rolls",
];
...
async function main() {
  ...
  console.log("\nTotal: " + all.length);
  fs.writeFileSync("db/mega-seed-3.sql", all.map(toSQL).join("\n"));
  console.log("Saved to db/mega-seed-3.sql");
